...
async function sendMessage() {
    ...
    try {
        ...
        hideLoading();
        addErrorMessage('Failed to connect to the chatbot API. Make sure the Flask server is running on ' + API_URL);
...
function initChatbot() {
    ...
    if (!chatbotContainer) {
        console.error('Chatbot container not found. Make sure there is an element with id="chatbot-container"');
        return;
    }
